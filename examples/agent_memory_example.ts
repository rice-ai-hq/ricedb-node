...
async function main() {
  ...
  try {
    ...
    console.log("==================================================");
    console.log(`ℹ️  Clearing memory for session: ${sessionId}`);
    ...
    console.log("ℹ️  ScannerAgent is analyzing the codebase...");
    ...
    console.log(
      "ℹ️  ReviewerAgent is filtering memory for 'high' priority findings..."
    );
    ...
    try {
      ...
      console.log("ℹ️  Linking auth.ts -> IMPORTS -> login.ts");
