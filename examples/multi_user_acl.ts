...
async function main() {
  ...
  try {
    ...
    for (const [name, info] of Object.entries(usersConfig)) {
      console.log(`ℹ️  Creating user '${name}'...`);
      try {
        // Cleanup if exists
        try {
    ...
    console.log("ℹ️  Charlie searching for reports...");
    ...
    console.log("ℹ️  Bob searching for reports (Should fail)...");
    ...
    console.log("ℹ️  Alice revoking Charlie's access...");
